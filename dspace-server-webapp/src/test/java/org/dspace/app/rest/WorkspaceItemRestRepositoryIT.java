...
public class WorkspaceItemRestRepositoryIT extends AbstractControllerIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        accessConditionConfiguration = DSpaceServicesFactory.getInstance().getServiceManager()
                                                            .getServiceByName("accessConditionConfigurationDefault",
                                                                              AccessConditionConfiguration.class);
    ...
    public void findAllForbiddenTest() throws Exception {
        ...
        getClient(authTokenAdmin).perform(get("/api/submission/workspaceitems"))
                                 ...
                                 .andExpect(jsonPath("$._links.self.href",
                                                     Matchers.containsString("/api/submission/workspaceitems")))
                                 .andExpect(jsonPath("$.page.size", is(20)))
    ...
    public void findOneRelsTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID() + "/collection"))
                            ...
                            .andExpect(jsonPath("$", Matchers
                                .is(CollectionMatcher.matchCollectionEntry(col1.getName(), col1.getID(),
                                                                           col1.getHandle()))
                            ));
    ...
    public void findBySubmitterTest() throws Exception {
                                  ...
                                  .andExpect(jsonPath("$._embedded.workspaceitems",
                                                      Matchers.containsInAnyOrder(
                                                          WorkspaceItemMatcher.matchItemWithTitleAndDateIssued(
                                                              workspaceItem1, "Workspace Item 1",
                                                              "2017-10-17"),
                                                          WorkspaceItemMatcher.matchItemWithTitleAndDateIssued(
                                                              workspaceItem2, "Workspace Item 2",
                                                              "2016-02-13"))))
                                  .andExpect(jsonPath("$._embedded.workspaceitems",
                                                      Matchers.not(contains(WorkspaceItemMatcher
                                                                                .matchItemWithTitleAndDateIssued(
                                                                                    workspaceItem3, "Workspace Item 3",
                                                                                    "2016-02-13")))))
                                  .andExpect(jsonPath("$.page.size", is(20)))
                                  .andExpect(jsonPath("$.page.totalElements", is(2)));
        ...
        getClient(tokenSubmitter1).perform(get("/api/submission/workspaceitems/search/findBySubmitter")
                                  ...
                                  .andExpect(status().isOk())
                                  .andExpect(jsonPath("$._embedded.workspaceitems",
                                                      contains(WorkspaceItemMatcher.matchItemWithTitleAndDateIssued(
                                                          workspaceItem2,
        ...
        try {
            getClient(authToken).perform(multipart("/api/submission/workspaceitems")
                                ...
                                .andExpect(jsonPath("$._embedded.workspaceitems[0].sections.traditionalpageone"
                                                    ...
                                                    is("Mock ISSN")))
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.traditionalpageone['dc.type'][0].value",
                                    is("Mock subtype")))
                                .andExpect(
                                    jsonPath("$._embedded.workspaceitems[0]._embedded.collection.id",
                                             is(col1.getID().toString())))
    ...
    public void createSingleWorkspaceItemFromRISWithOneEntryTest() throws Exception {
        ...
        try {
            getClient(authToken).perform(multipart("/api/submission/workspaceitems")
                                ...
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.traditionalpageone['dc.title'][1].value",
        ...
        try {
            getClient(authToken).perform(multipart("/api/submission/workspaceitems")
                                ...
                                .andExpect(jsonPath("$._embedded.workspaceitems[0].sections.traditionalpageone"
                                                    ...
                                                    is("Astorga-Wells, Juan")))
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.upload.files[0].metadata['dc.source'][0]" +
                                        ".value",
                                    is("/local/path/pubmed-test.xml")))
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.upload.files[0].metadata['dc.title'][0]" +
                                        ".value",
                                    is("pubmed-test.xml")))
                                .andDo(result -> idRef.set(read(result.getResponse().getContentAsString(),
                                                                "$._embedded.workspaceitems[*].id")));
    ...
    public void createWorkspaceItemFromPDFFileTest() throws Exception {
        ...
        try {
            getClient(authToken).perform(multipart("/api/submission/workspaceitems")
                                ...
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.traditionalpageone['dc.contributor" +
                                        ".author'][0].value",
                                    is("Bollini, Andrea")))
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.traditionalpageone['dc.date.issued'][0]" +
                                        ".value",
                                    is("2018")))
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.traditionalpagetwo['dc.description" +
                                        ".abstract'][0].value",
                                    is("This is the abstract of our PDF file")))
                                // we can just check that the pdf is stored in the item
                                .andExpect(
                                    jsonPath(
                                        "$._embedded.workspaceitems[0].sections.upload.files[0].metadata['dc" +
                                            ".title'][0].value",
                                        is("myfile.pdf")))
                                .andExpect(jsonPath(
                                    "$._embedded.workspaceitems[0].sections.upload.files[0].metadata['dc.source'][0]" +
    ...
    public void globalValidationErrorsTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + workspaceItem2.getID()))
                            ...
                            .andExpect(jsonPath("$.errors[?(@.message=='error.validation.test')]", allOf(
                                ...
                                contains(
                                    hasJsonPath("$.paths[1]", is("/sections/traditionalpageone/dc.identifier.doi"))))));
    }
    ...
    public void patchUpdateMetadataWithBindTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$",
                                                ...
                                                Matchers.is(
                                                    WorkspaceItemMatcher.matchItemWithTypeAndSeries(witem, null,
                                                                                                    null))));
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$.errors").doesNotExist())
                            .andExpect(jsonPath("$",
                                                // Check this - we should now match an item with the expected type
                                                // and series
                                                Matchers.is(
                                                    WorkspaceItemMatcher.matchItemWithTypeAndSeries(witem,
                                                                                                    "Technical Report",
                                                                                                    null))));
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$.errors").doesNotExist())
                            .andExpect(jsonPath("$",
                                                // Check this - we should match an item with the expected series and
                                                // type
                                                Matchers.is(
                                                    WorkspaceItemMatcher.matchItemWithTypeAndSeries(witem,
                                                                                                    "Technical Report",
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$",
                                                ...
                                                Matchers.is(
                                                    WorkspaceItemMatcher.matchItemWithTypeAndSeries(witem, "Article",
                                                                                                    null))));
    ...
    public void patchUpdateMetadataWithBindForRepeatedFieldConfigurationTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$",
                                                ...
                                                Matchers.is(
                                                    WorkspaceItemMatcher.matchItemWithTypeFieldAndValue
                                                                            (witem, "typebindtest", null,
                                                                             "dc.identifier.isbn", null))));
...
//                .andExpect(jsonPath("$.errors").doesNotExist())
                            .andExpect(jsonPath("$",
                                                ...
                                                Matchers.is(
                                                    WorkspaceItemMatcher
                                                        .matchItemWithTypeFieldAndValue(witem,
                                                                                        "typebindtest",
                                                                                        "Book",
                                                                                        "dc.identifier.isbn",
                                                                                        null))));
    ...
    public void stepAndGlobalValidationErrorsTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + workspaceItem2.getID()))
                            ...
                            .andExpect(jsonPath("$.errors[?(@.message=='error.validation.required')]",
                                                contains(
                                                    hasJsonPath("$.paths[0]",
                                                                is("/sections/traditionalpageone/dc.date.issued")))))
                            .andExpect(jsonPath("$.errors[?(@.message=='error.validation.test')]", allOf(
                                contains(hasJsonPath("$.paths[0]", is("/sections/traditionalpageone/dc.title"))),
                                contains(
                                    hasJsonPath("$.paths[1]", is("/sections/traditionalpageone/dc.identifier.doi"))))));
    ...
    public void lookupDOIMetadataTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpageone['dc.title'][0].value",
                                                is("Multistep microreactions with proteins using electrocapture " +
                                                       "technology.")))
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpagetwo['dc.description.abstract'][0].value",
                                                is("A method to perform multistep reactions by means of " +
                                                       "electroimmobilization of a " +
                                                       "target molecule in a microflow stream is presented. A target " +
                                                       "protein is captured " +
                                                       "by the opposing effects between the hydrodynamic and electric" +
                                                       " forces, after which " +
                                                       "another medium is injected into the system. The second medium" +
                                                       " carries enzymes or " +
                                                       "other reagents, which are brought into contact with the " +
                                                       "target protein and react." +
                                                       " The immobilization is reversed by disconnecting the electric" +
                                                       " field, " +
                                                       "upon which products are collected at the outlet of the device" +
                                                       " for analysis. On-line " +
                                                       "reduction, alkylation, and trypsin digestion of proteins is " +
                                                       "demonstrated and was" +
    ...
    public void lookupScopusMetadataTest() throws Exception {
        ...
        if (StringUtils.isBlank(apikey)) {
            ...
            getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                                ...
                                .andExpect(jsonPath("$.sections.traditionalpageone['dc.title'][0].value",
                                                    is("Partial orders for zero-sum arrays with applications to " +
                                                           "network theory")))
                                .andExpect(jsonPath("$.sections.traditionalpageone['dc.date.issued'][0].value",
                                                    is("2017-02-01")))
                                .andExpect(jsonPath("$.sections.traditionalpageone['dc.contributor.author'][0].value",
                                ...
                                .andExpect(jsonPath("$.sections.traditionalpageone['dc.identifier.issn'][0].value",
                                                    is("17511577")))
                                .andExpect(jsonPath("$.sections.traditionalpagetwo['dc.description.abstract'][0].value",
                                                    is(StringEscapeUtils.unescapeJava(
                                                        "\\u00A9 2016 Elsevier Ltd In this contribution" +
                                                            " we study partial orders in the set" +
                                                            " of zero-sum arrays. Concretely, these partial orders " +
                                                            "relate to local and" +
                                                            " global hierarchy and dominance theories. The exact " +
                                                            "relation between hierarchy" +
                                                            " and dominance curves is explained. Based on this " +
                                                            "investigation we design a" +
                                                            " new approach for measuring dominance or stated " +
                                                            "otherwise, power structures," +
                                                            " in networks. A new type of Lorenz curve to measure " +
                                                            "dominance or power is proposed," +
                                                            " and used to illustrate intrinsic characteristics of " +
                                                            "networks. The new curves," +
                                                            " referred to as D-curves are partly concave and partly " +
                                                            "convex. As such they do" +
                                                            " not satisfy Dalton's transfer principle. Most " +
                                                            "importantly, this article" +
                                                            " introduces a framework to compare different power " +
                                                            "structures as a whole." +
                                                            " It is shown that D-curves have several properties " +
                                                            "making them suitable to" +
                                                            " measure dominance. If dominance and being a subordinate" +
                                                            " are reversed, the" +
        ...
        if (StringUtils.isBlank(wosApiKey)) {
            ...
            getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                                ...
                                .andExpect(jsonPath("$.sections.traditionalpageone['dc.identifier.isi'][0].value",
                                                    is("WOS:000270372400005")))
                                .andExpect(jsonPath("$.sections.traditionalpageone['dc.title'][0].value",
                                                    is("Individual Susceptibility to Cadmium Toxicity and " +
                                                           "Metallothionein Gene Polymorphisms:" +
                                                           " with References to Current Status of Occupational " +
                                                           "Cadmium Exposure")))
...
//                                                  .grantLicense()
    ...
    public void patchReplaceMetadataOnItemStillInSubmissionTest() throws Exception {
        ...
        getClient(tokenAdmin).perform(get("/api/core/items/" + idItem))
                             ...
                             .andExpect(jsonPath("$", Matchers.is(ItemMatcher.matchItemWithTitleAndDateIssued
                                                                                 (witem.getItem(), "Workspace Item 1",
                                                                                  "2017-10-17"))));
    }
    ...
    public void patchDeleteSectionTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpagetwo['dc.subject']").doesNotExist())
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.description.abstract']").doesNotExist())
        ;
    }
    ...
    public void patchAddMultipleMetadataValuesTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(jsonPath("$.errors").doesNotExist())
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.subject'][0].value", is("First Subject")))
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpagetwo['dc.subject'][1].value", is("Subject1")))
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.subject'][2].value", is("Mid Subject")))
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpagetwo['dc.subject'][3].value", is("Subject2")))
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.subject'][4].value", is("Last Subject")))
        ;
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.subject'][4].value", is("Last Subject")))
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.subject'][5].value", is("Final Subject")))
        ;
    }
    ...
    public void patchUploadTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(jsonPath("$.sections.upload.files[0].metadata['dc.title'][0].value",
                                                is("newfilename.pdf")))
                            .andExpect(
                                jsonPath("$.sections.upload.files[0].metadata['dc.description']").doesNotExist());
    ...
    public void patchUploadAddAndRemoveAccessConditionTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(jsonPath("$.sections.upload.files[0].accessConditions[0].name", is("embargo")))
                            .andExpect(
                                jsonPath("$.sections.upload.files[0].accessConditions[0].startDate", is(startDateStr)))
                            .andExpect(jsonPath("$.sections.upload.files[0].accessConditions[0].endDate", nullValue()));
    ...
    public void createWorkspaceItemFromExternalSources() throws Exception {
        ...
        try {
            ...
            MvcResult mvcResult = getClient(token).perform(post("/api/submission/workspaceitems?owningCollection="
                                                               ...
                                                               .content(
                                                                   "https://localhost:8080/server/api/integration/" +
    ...
    public void lookupPubmedMetadataTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpageone['dc.identifier.pmid'][0].value",
                                                is("18926410")))
                            .andExpect(jsonPath("$.sections.traditionalpageone['dc.title'][0].value",
                                                is("Transfer of peanut allergy from the donor to a lung transplant " +
                                                       "recipient.")))
                            .andExpect(jsonPath("$.sections.traditionalpageone['dc.date.issued'][0].value",
    ...
    public void patchDeleteSectionWithEPersonTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                            ...
                            .andExpect(
                                jsonPath("$.sections.traditionalpagetwo['dc.description.abstract']").isNotEmpty());
    ...
    public void patchAddMetadataToGroupTypeMetadataTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(jsonPath("$.sections.traditionalpageone-cris['dc.contributor.author'][0].value",
                                                is("Mykhaylo Boychuk")))
                            .andExpect(
                                jsonPath("$.sections.traditionalpageone-cris['person.affiliation.name'][0].value",
                                         is("4science")));
    ...
    public void patchAddMetadataToInlineGroupTypeMetadataTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(status().isOk())
                            .andExpect(
                                jsonPath("$.sections.traditionalpageone-cris['orgunit.identifier.name'][0].value",
                                         is("test name")))
    ...
    public void patchUploadAddMultiAccessConditionTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(status().isOk())
                            .andExpect(
                                jsonPath("$.sections.upload.files[0].accessConditions[0].name", is("openaccess")))
                            .andExpect(
                                jsonPath("$.sections.upload.files[0].accessConditions[1].name", is("administrator")));
    ...
    public void lookupPubmedMetadataUsingDoiInstedPebmedIdTest() throws Exception {
        ...
        getClient(authToken).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                            ...
                            .andExpect(
                                jsonPath("$.sections.traditionalpageone['dc.date.issued'][0].value").doesNotExist())
                            .andExpect(jsonPath(
                                "$.sections.traditionalpageone['dc.contributor.author'][0].value").doesNotExist())
                            .andExpect(jsonPath(
                                "$.sections.traditionalpagetwo['dc.description.abstract'][0].value").doesNotExist());
        ...
        getClient(authToken).perform(get(workspaceItemsUri + workspaceItem3.getID()))
                            ...
                            .andExpect(jsonPath("$.errors[?(@.message=='error.validation.required')]",
                                                contains(
                                                    hasJsonPath("$.paths", contains(
                                                        hasJsonPath("$",
                                                                    Matchers.is("/sections/qualdroptest/dc.identifier"))
                                                    )))));
    }
    ...
    public void afterAddingAccessConditionBitstreamMustBeDownloadableTest() throws Exception {
        ...
        try (InputStream is = IOUtils.toInputStream(bitstreamContent, Charset.defaultCharset())) {
            ...
            getClient(tokenSubmitter).perform(patch("/api/submission/workspaceitems/" + witem.getID())
                                                  ...
                                                  .contentType(MediaType.APPLICATION_JSON_PATCH_JSON))
                                     .andExpect(status().isOk())
                                     .andExpect(jsonPath("$.sections.upload.files[0].accessConditions[0].name",
                                                         is("administrator")))
                                     .andExpect(jsonPath("$.sections.upload.files[0].accessConditions[0].startDate",
                                                         nullValue()))
                                     .andExpect(jsonPath("$.sections.upload.files[0].accessConditions[0].endDate",
                                                         nullValue()));
    ...
    public void affterAddingAccessConditionItemMustBeAccessibleTest() throws Exception {
        ...
        getClient(tokenSubmitter).perform(get("/api/submission/workspaceitems/" + witem.getID()))
                                 ...
                                 .andExpect(jsonPath("$.sections.defaultAC.discoverable", is(true)))
                                 .andExpect(
                                     jsonPath("$.sections.defaultAC.accessConditions[0].name", is("administrator")))
                                 .andExpect(jsonPath("$.sections.defaultAC.accessConditions[1].name").doesNotExist());
    ...
    public void testAccessConditionRequirement() throws Exception {
        ...
        try {
            ...
            RelationshipTypeBuilder.createRelationshipTypeBuilder(context, publicationType, publicationType,
                                                                  "isCorrectionOfItem", "isCorrectedByItem", 0, 1, 0,
                                                                  1);
    ...
    public void createItemWithoutEntityTypeIfCollectionHasBlankEntityType() throws Exception {
        ...
        Collection collection2 = CollectionBuilder.createCollection(context, community)
                                                  .withName("Collection 2")
                                                  // NOTE: has empty entity type, this is by default the case when a
                                                  // collection is created in the GUI
                                                  .withEntityType("")
                                                  .build();
