...
public class CustomUrlStepIT extends AbstractControllerIntegrationTest {
    ...
    @Test
    public void testCustomUrlReplacementOnEditItem() throws Exception {
    ...
    @Test
    public void testRedirectedUrlDeletionOnEditItem() throws Exception {
        ...
        getClient(getAuthToken(admin.getEmail(), password))
            .perform(get("/api/core/edititems/" + editItem.getID() + ":MODE-CUSTOM-URL"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.errors").doesNotExist())
            .andExpect(jsonPath("$.sections.custom-url.url", is("my-custom-url")))
            .andExpect(jsonPath("$.sections.custom-url.redirected-urls",
    ...
    @Test
    public void testEmptyCustomUrlReplacementOnEditItem() throws Exception {
        ...
        getClient(getAuthToken(admin.getEmail(), password))
            ...
            .andExpect(jsonPath("$.[?(@.message=='error.validation.custom-url.empty')]",
                contains(hasJsonPath("$.paths", contains(hasJsonPath("$", is("/sections/custom-url/url")))))));
    ...
    @Test
    public void testInvalidCustomUrlReplacementOnEditItem() throws Exception {
        ...
        getClient(getAuthToken(admin.getEmail(), password))
            .perform(patch("/api/core/edititems/" + editItem.getID() + ":MODE-CUSTOM-URL")
                ...
                .contentType(MediaType.APPLICATION_JSON_PATCH_JSON))
            .andExpect(status().isUnprocessableEntity())
            .andExpect(jsonPath("$.[?(@.message=='error.validation.custom-url.invalid-characters')]",
                contains(hasJsonPath("$.paths", contains(hasJsonPath("$", is("/sections/custom-url/url")))))));

    }

    @Test
    public void testAlreadyExistingCustomUrlReplacementOnEditItem() throws Exception {
        ...
        getClient(getAuthToken(admin.getEmail(), password))
            .perform(patch("/api/core/edititems/" + editItem.getID() + ":MODE-CUSTOM-URL")
                ...
                .contentType(MediaType.APPLICATION_JSON_PATCH_JSON))
            .andExpect(status().isUnprocessableEntity())
            .andExpect(jsonPath("$.[?(@.message=='error.validation.custom-url.conflict')]",
                contains(hasJsonPath("$.paths", contains(hasJsonPath("$", is("/sections/custom-url/url")))))));
